...
public class DetailsActivity extends AppCompatActivity {
    ...
    private int cnt = 0;
    private myAppWidget dynamicReceiver = new myAppWidget();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        car.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dynamic_filter.addAction("com.example.caiye.lab3.dynamic_widget");
                registerReceiver(dynamicReceiver,dynamic_filter);
                //发送动态广播
                Intent broadcastIntent = new Intent();
                broadcastIntent.setAction("com.example.caiye.lab3.dynamic_widget");
                broadcastIntent.putExtra("name",showName);
                broadcastIntent.putExtra("pic",showPic);
